...
//Wire.beginTransmission(compass_address);
  ...
  Send_I2C_Byte(HMC5883L_I2C_ADDRESS,HMC5883L_MODE_REG,0X01); 	
...
void myI2C::compass_offset_calibration(int select, unsigned char DEVICE_ADDR){
 ...
 // Configuring the Control register for Positive Bais mode
  ...
  //Wire.beginTransmission(compass_address);
  i2cSetAddress(DEVICE_ADDR);
  Send_I2C_Byte(HMC5883L_I2C_ADDRESS,HMC5883L_CONFIG_REG_A,0x71);	
  //Wire.write(0x00);
  ...
  // *****************************************************************************************
   ...
   // while(millis()-t <= 30000){
      ...
      if (compass_debug == 1){  //------------------ Debug Data
        cout<<compass_x_scalled;
        
        cout<<	compass_y_scalled;

        cout<<	compass_z_scalled;
        }//--------------------------------- End Debug Data
