...
int main(){
  ...
  i2cptr->compass_x_offset = 242.18;
  i2cptr->compass_y_offset = 207.18;
  i2cptr->compass_z_offset = 206.38;
  
  i2cptr-> compass_x_gainError = 1.03;
  i2cptr->compass_y_gainError = 1.11;
  i2cptr->compass_z_gainError = 1.03;
...
while(1){
 // cout <<"compassx_offset " <<compass_x_offset; 
  i2cptr->Send_I2C_Byte(HMC5883L_I2C_ADDRESS,HMC5883L_MODE_REG,0X00);
