...
int main(int argc, char *argv[])
{
	...
	float IMUoffsetGyro=i2cptr->Itg3200calibrate();
	cout <<"offset is:" << IMUoffsetGyro <<endl;
	// Initialization 
	float headingOffset=i2cptr->HMC5883Lcalibrate();
	cout <<"heading offset is:" << headingOffset <<endl;
...
float getHeading() {	
	...
	return headingDegrees*M_PI/180;
}
