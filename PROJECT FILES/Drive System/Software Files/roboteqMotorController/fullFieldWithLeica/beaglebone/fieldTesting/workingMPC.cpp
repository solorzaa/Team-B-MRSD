...
double rightWheel_RPM = 30/M_PI*( linearVelocity + angularVelocity * botRadius ) / wheelRadius;
double leftWheel_RPM = 30/M_PI*( linearVelocity - angularVelocity * botRadius ) / wheelRadius;
