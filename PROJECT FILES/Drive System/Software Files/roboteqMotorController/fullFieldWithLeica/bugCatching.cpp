...
int counts_per_revolution = 1250; //5500;
...
double pathHorizon = 5; 	//Model Predictive Control will look ahead 1 sec to predict a path
double timeStep = 0.01; 	//The resolution of the MPC path will be 0.1 seconds
...
double rightWheel_RPM = 60/M_PI*( linearVelocity + angularVelocity * botRadius ) / wheelRadius;
double leftWheel_RPM = 60/M_PI*( linearVelocity - angularVelocity * botRadius ) / wheelRadius;
